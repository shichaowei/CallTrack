...
dp.sh.Highlighter.prototype.Highlight = function(code)
{
	function Trim(str)
	{
		// Taken from version 3 of syntaxhighlighter 
		// <https://github.com/alexgorbatchev/SyntaxHighlighter/blob/master/scripts/shCore.js>
...
//			if(tags[i].getAttribute('name') == name)
      // The following code replacement should support this notation: class="programlisting csharp", 
      // where 'programlisting' is the string 'name' that is looked for.
      var soso = tags[i].className.split(' ');
      if(soso[0] == name)
				list.push(tags[i]);
    }
	}

  function GetBrushFromClassAttribute(classAttributeValue) {
    return classAttributeValue.substring(classAttributeValue.lastIndexOf(' ') + 1);
  }
...
//		language = options[0].toLowerCase();
		language = GetBrushFromClassAttribute(options[0].toLowerCase());
